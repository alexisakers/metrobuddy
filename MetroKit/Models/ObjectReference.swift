...
///
/// Using this class enables the data store to access the object by ID when editing it, while hiding the actual instance of the `NSManagedObject`. You can access the snapshot's data through the `object` property, or directly from the
/// reference, since it supports dynamic member lookup.
@dynamicMemberLookup
